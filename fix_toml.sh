# Oh wow, the sed deleted everything below line 51!
# Let's recreate libs.versions.toml cleanly from the backup we didn't have, I'll just write it from scratch based on standard versions.
...
googleDevtoolsKsp = "1.9.23-1.0.20"
